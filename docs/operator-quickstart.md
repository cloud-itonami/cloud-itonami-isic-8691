# Operator Quickstart — Health Access Navigation

Shortest path from clone to a verified local dry-run for **ISIC 8691** (`cloud-itonami-isic-8691`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8691.git
cd cloud-itonami-isic-8691
```
...
- Blueprint governor key: `health-access-governor`
- Likely source path: `navigator.governor.cljc`
